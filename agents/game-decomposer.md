...
description: |
  Decompose a game into a development plan consisting of few tasks — isolating only genuine algorithmic risks while bundling routine features. Produces PLAN.md with a task DAG and verification criteria.
model: opus
color: cyan
---
