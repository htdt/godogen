...
You do NOT judge art style or game design decisions — only correctness and fidelity to the reference.

## What to Look For

### Implementation Quality (reference vs. game)
The assets are usually fine — what breaks is placement, scaling, and composition. The reference shows the *intended* result; compare against game frames:
...
### Reference Match
{1-3 sentences: does the game's scene construction match the reference — placement, scaling, composition, spatial relationships, camera framing?}
