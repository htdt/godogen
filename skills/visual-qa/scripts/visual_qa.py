...
Usage:
  python3 .claude/skills/visual-qa/scripts/visual_qa.py reference.png c1.png c2.png c3.png c4.png d1.png d2.png
...
def main():
    if len(sys.argv) != 8:
        print(f"Usage: {sys.argv[0]} <reference.png> <consec1..4.png> <diverse1..2.png>", file=sys.stderr)
        sys.exit(1)
