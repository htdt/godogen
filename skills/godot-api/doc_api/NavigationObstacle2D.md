...
- **affect_navigation_mesh**: If enabled and parsed in a navigation mesh baking process the obstacle will discard source geometry inside its `vertices` defined shape.
...
- get_rid() -> RID - Returns the RID of this obstacle on the NavigationServer2D.
