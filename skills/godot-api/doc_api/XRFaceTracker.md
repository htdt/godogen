...
- **blend_shapes**: The array of face blend shape weights with indices corresponding to the `BlendShapeEntry` enum.

**Methods:**
- get_blend_shape(blend_shape: int) -> float - Returns the requested face blend shape weight.
- set_blend_shape(blend_shape: int, weight: float) - Sets a face blend shape weight.
...
**BlendShapeEntry:** FT_EYE_LOOK_OUT_RIGHT=0, FT_EYE_LOOK_IN_RIGHT=1, FT_EYE_LOOK_UP_RIGHT=2, FT_EYE_LOOK_DOWN_RIGHT=3, FT_EYE_LOOK_OUT_LEFT=4, FT_EYE_LOOK_IN_LEFT=5, FT_EYE_LOOK_UP_LEFT=6, FT_EYE_LOOK_DOWN_LEFT=7, FT_EYE_CLOSED_RIGHT=8, FT_EYE_CLOSED_LEFT=9, ...
  ...
  - FT_MAX: Represents the size of the `BlendShapeEntry` enum.
