...
`reference.png` — default to a 1K 16:9 image. Match the reference aspect ratio to the Bevy window or offscreen capture target you expect to ship. If the project keeps the scaffold default, stay at 16:9.
