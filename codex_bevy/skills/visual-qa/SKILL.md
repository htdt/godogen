...
name: visual-qa
description: |
  Visual quality assurance for gameplay screenshots. Use when you need to compare screenshots against a reference, inspect motion across frames, or answer a visual debugging question about a Bevy game.
---
...
- Engine fallback materials or obvious missing-texture placeholders
