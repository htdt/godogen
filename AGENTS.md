...
- Local generation is documented and coded in godogen_assets. `asset-gen` links to its docs with a short TL;DR and adds only what the game side needs; never copy its instructions or tools here.
