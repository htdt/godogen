...
```
Skill(skill="visual-qa") "Check reference.png against screenshots/{task}/still.png — Goal: ..., Requirements: ..., Verify: ..."
```
...
FRAMES=$(ls screenshots/{task}/frames/frame_*.png | awk "NR % $STEP == 0" | tr '\n' ' ')
...
```
Skill(skill="visual-qa") "Are any surfaces showing missing-texture checkerboards or obvious fallback materials? screenshots/{task}/still.png"

Skill(skill="visual-qa") "Does the enemy patrol path form a loop? screenshots/{task}/frames/frame_00001.png screenshots/{task}/frames/frame_00010.png screenshots/{task}/frames/frame_00020.png"

Skill(skill="visual-qa") "The door should open when player approaches. Does it? InteractionSystem triggers at 2m, the door should play its open clip once. screenshots/{task}/frames/frame_*.png"
```
...
Skill(skill="visual-qa") "Check reference.png against screenshots/{task}/still.png — Goal: ..."

# Native image analysis (Claude vision)
Skill(skill="visual-qa") "--native Check reference.png against screenshots/{task}/still.png — Goal: ..."

# Both — aggregated verdict (stricter wins, issues merged)
Skill(skill="visual-qa") "--both Check reference.png against screenshots/{task}/still.png — Goal: ..."
```
