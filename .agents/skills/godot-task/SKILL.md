...
## Godot Environment Setup

In sandboxed environments, initialize writable user paths and reuse them for every Godot command:
...
The orchestrating workflow decides whether to adjust the task, re-scaffold, or accept the current state.
