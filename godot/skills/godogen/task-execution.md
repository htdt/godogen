...
Write `task.md` at the project root once, containing the original task literal verbatim minus dropped unsupported features. It is the single source of truth for what is being built and is not rewritten on retries.
